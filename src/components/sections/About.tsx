    ...
    <Section className="bg-white py-16 sm:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="relative aspect-[16/10] overflow-hidden rounded-3xl shadow-card ring-1 ring-black/5">
            <Image
              src="/images/team-over-ons.png"
              alt="Team van Dierenambulance Waterland"
              fill
